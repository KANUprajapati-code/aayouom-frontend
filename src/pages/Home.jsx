                ...
                {(activeBanners[currentSlide].title1 || activeBanners[currentSlide].title2) && (
                  <>
                    ...
                    <div className="absolute inset-0 z-10 flex flex-col justify-center px-6 md:px-16 lg:px-20 max-w-3xl space-y-2 md:space-y-4 pointer-events-none">
                      ...
                      <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-xl md:text-3xl lg:text-4xl font-black text-white italic leading-[1.1] tracking-tighter">
                      ...
                      {activeBanners[currentSlide].description && (
                        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="text-xs md:text-sm lg:text-base text-slate-300 font-medium max-w-lg leading-relaxed line-clamp-2 md:line-clamp-none">
                          {activeBanners[currentSlide].description}
                        </motion.p>
                      )}
